$(function () {
    ...
    <div class="job-card row">
      ...
      <div class="col-sm-11 col-md-10 col-lg-10 job-card-content" style="overflow:hidden;position:relative">
        ...
        <p style="position:absolute;left;0;bottom:25px;">
    ...
    `);
          ...
          for (var j = 0; j < hireTab.length; j++) {
            ...
            <div class="job-card">
              ...
              <div class="job-card-content industryHireRight style="overflow:hidden">
              <p class="cio-career-h2">${job.position}</p>
                <p>
                  <span>${job.location}</span> |
                  <span>${job.level}</span> |
                ...
                <p class="ibm-padding-bottom-1">${job.description}</p>
                <p>
                  <a class="view-more" href="details.html?category=industry&index=${index}" style="bottom:2rem">View More -></a>
                </p>
              </div>
            </div>
        `);
